...
class ExplainabilityProvider(ABC):
    ...
    @abstractmethod
    def explain_prediction(self, model: BaseModel, input_data: torch.Tensor) -> Dict[str, Any]:
        """Generate explanation for a prediction."""
        pass
    
    @abstractmethod
    def get_global_importance(self, model: BaseModel, dataset: torch.Tensor) -> Dict[str, float]:
