...
try:
    from .regulatory_compliance import (
        RegulatoryComplianceValidator, ComplianceFramework,
        ComplianceViolation, AuditTrailEntry
    )
...
class ComplianceDocumentationGenerator:
    ...
    def __init__(self, output_dir: str = "compliance_reports"):
        ...
        logger.info(f"Compliance documentation generator initialized with output dir: {output_dir}")
    ...
    def generate_compliance_report(self, validator: RegulatoryComplianceValidator,
                                 framework: ComplianceFramework,
...
"""
    ...
    def generate_audit_trail_report(self, validator: RegulatoryComplianceValidator,
        ...
        audit_entries = validator.audit_manager.get_audit_trail(start_date, end_date, compliance_relevant_only=True)
...
"""
    ...
    def generate_comprehensive_compliance_documentation(self, validator: RegulatoryComplianceValidator,
        ...
        for framework in frameworks:
            try:
                report_path = self.generate_compliance_report(validator, framework, context)
        ...
        try:
            ...
            audit_report_path = self.generate_audit_trail_report(validator, start_date, end_date)
...
def create_compliance_documentation_generator(output_dir: str = "compliance_reports") -> ComplianceDocumentationGenerator:
    """Create compliance documentation generator."""
    return ComplianceDocumentationGenerator(output_dir)


def generate_all_compliance_reports(context: Dict[str, Any], output_dir: str = "compliance_reports") -> Dict[str, str]:
    ...
    reports = doc_generator.generate_comprehensive_compliance_documentation(validator, context)
