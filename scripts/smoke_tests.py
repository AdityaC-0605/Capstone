    ...
    def test_batch_prediction_endpoint(self) -> bool:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print(f"❌ Batch prediction endpoint returned status {response.status_code}")
                return False
        except Exception as e:
...
def main():
    parser = argparse.ArgumentParser(description="Run smoke tests for the Credit Risk AI API")
